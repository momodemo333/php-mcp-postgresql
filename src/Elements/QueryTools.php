...
class QueryTools
{
    ...
    {
        return $this->connectionService->executeWithRetry($callback, $maxRetries);
    }
    ...
    public function executeSelect(
        ...
        return $this->executeWithRetry(function() use ($query, $params) {
    ...
    public function executeInsert(
        ...
        return $this->executeWithRetry(function() use ($table, $data, $database) {
            $pdo = $this->connectionService->getConnection();
            $startTime = microtime(true);
    ...
    public function executeUpdate(
        ...
        return $this->executeWithRetry(function() use ($table, $data, $conditions, $database) {
            $pdo = $this->connectionService->getConnection();
            $startTime = microtime(true);
    ...
    public function executeDelete(
        ...
        return $this->executeWithRetry(function() use ($table, $conditions, $database, $limit) {
            $pdo = $this->connectionService->getConnection();
            $startTime = microtime(true);
    ...
    public function executeCustomQuery(
        ...
        return $this->executeWithRetry(function() use ($query, $params, $operation) {
            $pdo = $this->connectionService->getConnection();
            $startTime = microtime(true);
